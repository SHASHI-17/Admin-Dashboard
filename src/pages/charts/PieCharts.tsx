  ...
  return (
    <div className="adminContainer">
      ...
      <main className='chart-container'>
            ...
            <section>
              <div>
                <DoughnutChart labels={categories.map(i=>i.heading)} data={categories.map(i=>i.value)}
                              backgroundColor={categories.map(i=> `hsl(${i.value*5},${i.value}%, 50%)`)}
                              offset={[0, 0,0, 80]} legends={false} 
                />
              </div>
            ...
            <section>
              <div>
                <DoughnutChart labels={['In Stock','Out of Stock']} data={[40,20]}
                               backgroundColor={["hsl(269,80%,40%)", "rgb(53, 162, 255)"]}
                              offset={[0, 80]} legends={false} cutout={'70%'}
                />
              </div>
            ...
            <section>
              ...
              data={[32, 18, 5, 20, 25]}
              backgroundColor={["hsl(110,80%,40%)","hsl(19,80%,40%)","hsl(69,80%,40%)",
              "hsl(300,80%,40%)",
              "rgb(53, 162, 255)",
            ]}
              legends={false}
